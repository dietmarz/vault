...
=== Privat
* Alle adoc dateien nach md convertieren. zB Interview etc.
* Obsidian lernen
  ** https://www.youtube.com/watch?v=oE8HyLuHjsQ&ab_channel=Effective
  ** Was sind MOC? Gibt es einen kurs für linking your thinking?
