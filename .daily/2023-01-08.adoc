...
* Depot kündigen
* Lösung Monitor entsorgung
* qm Zahlen liefern
* Putzen, wischen küche etwas saugen
* Keller 30min
* [X] Sport
  ** [X] Rudern zwischendurch
  ** [X] 18:30 Joy Bodypump
* [X] t von md auf adoc
* t grep bauen
* Lesen Diät
...
== Daily
* Vom Featurebranch ein Release bauen
* Releases bauen

* KNOMP-28929-create-unlink-shipment-remote-api
  **  Matheus would like to discuss AirShipments
