...
=== Morgen
* [ ] Reichel anrufen wegen Röntgen
* [ ] Bütec buchholz besuchen
* [ ] FDW WVL 01.04.23 15 Anrufen! Was ist aus der OLB geworden



* [ ] Wolckenhauer und Heizung bezahlen
* [ ] Forecast monat abschicken & Korrigieren.
* [ ] Office Tisch frei bekommen.
* [ ] Heizung einstellen
* [ ] Jdw 15 Stadtrad ummelden
* [ ] Einkaufen
* [ ] Sport
* BKK überweisen
...
* [X] TMS Export deployen in FBranch. Wie lautet das Login für

 https://varnish-knomp29003-cp-474844.apps.emea.ocp.int.kn
