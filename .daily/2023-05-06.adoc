...
* [x] Umstellung fertig auf native SQL, Achtung TODO,
* [ ] Weiter: EspShipRepoInteTest zum laufen kriegen
* [ ] Sentry Logging
...
=== Heute, Wecker
* [ ] FdW 30 05 Montag Rentenversicherung, Beratung, ob Einzahlungen möglich sind. Welche Effektivität?
...
* [ ] Gutschrift Monitor prüfen
* [ ] BKK Rechnung faken
* [ ] Unterbacklogs aufgeben
...
* [ ] FdW 30 05 Was kann man online bei der deu Rentenvers machen?
* [ ] F W 30 SThree Monatsnachweise einsortieren und drucken
* [ ] JDW 30 Office: Farben definieren und neue Hängeregister Label farbig drucken!
* [ ] J   60 Office: Alte Ordner entsorgen, weiter hängeordner durchgehen
* [ ] JDW 30 PlaBewerbung fertig
* [ ] J w 30 Gmail alle Doings durchgehen & drucken. 2023 prüfen ob erledigt auch gedruckt wurde!
...
* [ ] FDW 05 05 Welcher KI aufgelegte ETF?
...
* [ ] FdW 45 03 Outcome Frame Dietmar Vermietet
...
* [R] P w 99 03 Frage stellen: Alle Methoden von CM zusammenfassen  und besser strukturieren als adoc wenn möglich.
