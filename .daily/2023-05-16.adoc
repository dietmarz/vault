...
* 1. rest-apis shipment-status & -admin incompatible releasen.
* 2. Version increment fehlte.
* 3. Nur bei mir SeaShipmentRepositoryIntegrationTest failed nach rebase mit Float difference, 15 statt 15.4. Ursache unbekannt. JDK?
* 4. EspSeaMasterShipmentServiceIntegrationTest räumt nicht richtig auf, deshalb, wenn alle tests laufen fällt meiner um.

* [ ] 80% Coverage, Edgecases mit Mockito
