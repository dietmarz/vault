...
* repo in domain verschieben
* EspStatusItem nach domain auch der ESSItemMapper, EventTypeUtil
* app  = 2Controler + StatusItemMapper, 3 Dinge!
* QueryDlsRedacteExecuort<AirShipmen>
* See SeaShipmentPredicates.lclShipmetByTrackingNumber

* Impediment
  **

----
[ERROR] Constraint: common:DomainDoesNotDependOnAPI
[ERROR] Severity: MAJOR
[ERROR] Number of rows: 7
[ERROR] Domain types shall not depend on API classes (neither own nor external).
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.EspShipmentStatusItemMapper -> kn.knlogin.esp.shipment.domain.status.api.EspShipmentStatusItem
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.ShipmentStatusService -> kn.knlogin.esp.shipment.domain.status.api.EspShipmentStatusItem
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.ShipmentContainerStatusService -> kn.knlogin.esp.shipment.domain.status.api.EspShipmentStatusItem
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.ShipmentContainerStatusService -> kn.knlogin.esp.shipment.domain.status.api.EspShipmentStatusItemMapper
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.ShipmentStatusService -> kn.knlogin.esp.shipment.domain.status.api.EspShipmentStatusItemMapper
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.ShipmentStatusService -> kn.knlogin.esp.shipment.domain.status.api.EventTypeUtil
[ERROR]   Dependency=kn.knlogin.esp.shipment.domain.status.api.ShipmentContainerStatusService -> kn.knlogin.esp.shipment.domain.status.api.EventTypeUtil
...
image::image-2023-05-30-12-38-45-470.png[]
image::image-2023-05-30-12-40-45-167.png[]
image::image-2023-05-30-12-41-49-525.png[]
...
* Monat Juni fertig machen
* Urlaub einreichen, Plan updaten
* Urlaub planen, Was mache ich im Urlaub?
* Monitor tauschen
...
==== Backlog nach Prio
* Wichtig und Doings per Mail durchgehen
