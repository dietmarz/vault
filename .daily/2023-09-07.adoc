...
=== Heute
ZArzt termin eintragen
* [ ] WVL FDW 60 09 Linas Bafög Antrag vorbereiten
...
* [ ] https://git.int.kn/projects/KNLOGIN/repos/esp-rest-apis/pull-requests/980/overview[PR RestApis]
...
* [X] deployen auf dem Featurebranch!
  ** Buchstabe Y
  ** https://jira.int.kn/browse/KNOMP-33274[SBA FB Env]
