...
git clone git@github.com:dietmarz/tracker.git
...
# focal not una or jammy

sudo apt-add-repository "deb [arch=$(dpkg --print-architecture)] https://apt.releases.hashicorp.com focal main"
sudo apt-get update
sudo apt install terraform

# Downlaod terragrunt_linux_amd64 from https://github.com/gruntwork-io/terragrunt/releases
...
# Auf der Website gibt es auch eine Info zum update
----
...
.Keyboard
----
# link:usr-share-X11-xkb-symbols-de.file[Beispiel-tastatur-Layout]
...
settings.tools.terminal.Project settings.Environment: ENV_EDITOR=/opt/android-studio/bin/studio.sh
----
